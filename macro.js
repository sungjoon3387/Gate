      ...
      ["인상 확정", {
        ...
        hist: [
          ...
          { y: "2015~2018", t: "천천히 올린 경우는 달랐다",
            d: "2015년 12월 첫 인상 후 3년에 걸쳐 2.5%까지 올렸습니다. 같은 인상인데 속도가 느리자 주식은 오히려 올랐습니다. 인상 자체보다 속도가 시장을 결정합니다.",
            k: "3년간 9회 인상 · S&P500 같은 기간 상승" }
        ]
      }],
      ["인하 확정", {
      ...
      ["플래트닝", {
        ...
        hist: [
          { y: "2022", t: "플래트닝이 역전까지 갔던 해",
            d: "짧은 쪽이 계속 빨리 오르다 결국 2년물이 10년물을 넘어섰습니다. 역사적으로 이 역전은 1~2년 뒤 침체를 예고해 왔습니다. 다만 2022년 역전 이후에는 침체가 오지 않아 '이번엔 달랐다'는 사례로도 남았습니다.",
            k: "2년물 4.7% vs 10년물 3.9% · 나스닥100 -33%" },
          { y: "2004~2006", t: "플래트닝이 위기의 전조였던 경우",
            d: "연준 인상으로 짧은 쪽이 오르는데 긴 쪽이 안 올라 커브가 평평해지다 역전됐고, 2년 뒤 금융위기가 왔습니다.",
            k: "17회 인상 · 2006년 커브 역전 → 2008년 위기" }
        ]
      }],
      ["스티프닝", {
        ...
        hist: [
          { y: "2023 8~10월", t: "신용등급 강등과 10년물 5% 돌파",
            d: "피치가 미국 신용등급을 AA+로 강등한 뒤 장기물이 앞장서 올랐습니다. 10년물이 2007년 이후 처음 5%를 넘었고, 주가는 3개월간 약 10% 조정받았습니다. 연준은 그동안 아무것도 하지 않았습니다.",
            k: "10년물 4.0% → 5.02% · 30년물이 상승 주도" },
          { y: "1994", t: "채권 대학살",
            d: "연준이 3%에서 6%로 올리는 동안 장기물이 더 크게 흔들렸습니다. 채권 가격이 급락하며 오렌지카운티가 파산했고, 전 세계 채권시장이 한 해 동안 무너졌습니다.",
            k: "30년물 6.2% → 8.2% · 채권 사상 최악의 해" }
        ]
      }],
      ["평행", {
        easy: "커브 전 구간이 비슷하게 움직였습니다. 특정 구간의 이야기가 아니라 금리 수준 자체의 재평가입니다. 정책 기대나 재정 불안 중 하나로 설명되지 않는, 더 근본적인 이동입니다.",
        hist: [
          { y: "2013", t: "테이퍼 텐트럼",
            d: "연준 의장이 자산매입 축소를 시사하자 커브 전체가 위로 밀렸습니다. 넉 달 만에 10년물이 1.6%에서 3.0%로 올랐고, 신흥국 통화가 급락했습니다. 정작 실제 축소는 그해 12월에야 시작됐습니다.",
            k: "10년물 1.6% → 3.0% · 신흥국 자금 대량 유출" }
        ]
      }]
    ],
      ...
      ["관찰", {
        ...
        hist: [
          { y: "2018년 4분기", t: "웃돈이 벌어지자 주가가 먼저 반응했다",
            d: "연준이 계속 올리는 가운데 스프레드가 100bp에서 160bp로 벌어졌습니다. S&P500은 그 분기에 약 20% 빠졌고, 연준이 이듬해 인상을 멈추자 스프레드와 주가가 함께 회복했습니다.",
            k: "IG 스프레드 100 → 160bp · S&P500 분기 -19.8%" }
        ]
      }],
      ["안정", {
      ...
      ["원화 약세", {
        ...
        hist: [
          { y: "2022", t: "주가는 빠졌는데 계좌는 덜 아팠다",
            ...
            k: "원/달러 +21% · 나스닥100 -33% · 원화 환산 손실 크게 축소" }
        ]
      }],
      ["중립", {
